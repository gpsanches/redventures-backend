...
# wsdl_path = '/home/gpsanches/Documents/TIM/wsNotificacaoRecarga.wsdl'
wsdl_path = None
...
class SoapHandler(SoapHandler, SDPMixin):
    ...
    def get(self):
        ...
        # Defines the NAMESERVICE i.e. wsdl_nameservice = 'module01/v1/recharge'
